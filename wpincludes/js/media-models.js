...
/************************************************************************/
/**
 * @output wpincludes/js/media-models.js
 */
...
_.extend( media, /** @lends wp.media */{
	 ...
	 *
	 * See wp.template() in `wpincludes/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.post() in `wpincludes/js/wp-util.js`.
	 *
	 ...
	 * See wp.ajax.send() in `wpincludes/js/wp-util.js`.
	 *
